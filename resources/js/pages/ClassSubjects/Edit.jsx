...
const ClassSubjectsEdit = ({ classSubject, classes, subjects, teachers }) => {
  ...
  const fields = [
    ...
    { name: 'section_id', label: 'Section', type: 'select', options: sections.map((s) => ({ value: s.id, label: s.name })) },
  ...
  return (
    <div className="flex">
      ...
      <div className="flex-1 ml-64 p-8 bg-white min-h-screen">
        <h1 className="text-2xl font-bold mb-6">Edit Subject Assignment</h1>
