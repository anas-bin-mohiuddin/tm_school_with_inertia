...
const ClassRoutinesCreate = ({ classes, sections, subjects, teachers }) => {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    Inertia.post('/class-routines', values);
  };
  ...
  return (
    <div className="flex">
      ...
      <div className="flex-1 ml-64 p-8 bg-white min-h-screen">
        <h1 className="text-2xl font-bold mb-6">Add Class Routine</h1>
...
export default ClassRoutinesCreate;
